...
public class SeacrchStudentDetailsPanel extends JPanel
{
    public JLabel lblView,lblFName,lblMName,lblLName,lblGen,lblDOB,lblConNo,lblGConNo,lblLandLine,lblSEID,lblGEID,lblAdd,lblCatagory,lblBranch,lblBatch,lblAdmission,lblE1,lblE2;
    ...
    public SeacrchStudentDetailsPanel(MyGui o,String fn, String mn, String ln, String gender, String dob, String stuCon, String gurCon, String landLine, String stuEmail, String gurEmail, String address, String category, String branch, String batch,  String admType)
    {
